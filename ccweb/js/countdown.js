function Countdown()
{
    ...
    var targetday = new Date(2017,5,23); 
...
Countdown.prototype.update_target = function()
{
    ...
    hours = this.hours;
    days = this.days;
    //append a 0 in front of the number if it less than 10. "9 days" will be shown as "09" days.
    if(days<10)
      days = "0"+days;
    if(seconds<10)
        seconds = "0"+seconds;
    ...
    //change innerHTML values in main page 
